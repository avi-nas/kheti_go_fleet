...
class OtpScreen extends StatefulWidget {
  ...
  const OtpScreen({super.key, required this.verificationId,required this.phoneNumberEntered});
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () async {
                      ...
                      await FirebaseAuth.instance
                          ...
                          .then((value)async{
                            await AppAuthProvider.setCurrentUser('user');
                            if( await HandleUserData.isNewUser(HandleUserData.firebaseAuthInstance.currentUser?.phoneNumber)){
